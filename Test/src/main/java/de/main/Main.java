...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		final PrintWriter normalWriter = new PrintWriter(new BufferedWriter(new FileWriter("log.log")));
		final PrintWriter errorWriter = new PrintWriter(new BufferedWriter(new FileWriter("error.log")));
		final LoggerAndExceptionHandlerFacadeIF logFacade = new LogExceptionFacade(errorWriter, normalWriter, LogLevel.NORMAL);
